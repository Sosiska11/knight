    ...
    for (const sub of expiredList) {
      ...
      try {
        await bot.telegram.sendMessage(
          sub.tg_id,
          `
⚠️ <b>Время вашего доступа к ИТ-платформе Knight Space истекло!</b>

Доступ к материалам временно приостановлен. Вы можете легко восстановить его в любой момент!
При продлении доступа ваш токен авторизации останется прежним.
