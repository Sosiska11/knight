...
async function run() {
  ...
  console.log('=== Reading internal/handler/handler.go ===');
  const catHandler = await ssh.execCommand('cat /root/yac-ws-bridge/adapter/internal/handler/handler.go');
  console.log(catHandler.stdout);
